...
\textit{degrib} mit den entsprechenden Parametern aufgerufen und
dessen Ausgabe auf gültige Werte hin überprüft. Die Anzahl dieser
...
Spot \textit{Esposende} in Portugal zu sehen. Der Algorithmus wurder
hier mit einer maximalen Distanz $\Delta$ von 100 Kilometern, und
einer Richtungsschrittweite von $\alpha = 10^{\circ}$
initialisiert. Auf halber Distanz wurde bereits eine Position mit
gültigen Werten gefunden und in den weiteren Iterationen nur noch
