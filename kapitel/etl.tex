...
\subsubsection{Repräsentation der Vorhersagedaten}
...
\ref{tab:forecasts} zu sehen ist. In dieser Relation wird für jeden
Vorhersagezeitpunkt ein Datensatz gespeichert. Die Spalten der Tabelle
enthalten den Fremdschlüssel eines Spots, den Zeitpunkt der Vorhersage
und die Werte der Vorhersageelemente. Die Attribute
...
die beiden Modell erstellt wurden. Die beiden Attribute
...
repräsentieren die Vorhersageelemente der beiden Modelle und enthalten
deren Werte.
