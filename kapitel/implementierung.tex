...
ohnehin zu normalisierende Inhalt von Datenbanken gemeint, sondern
auch Konfigurationsdaten und vor allem Programmcode.
...
vermieden, bzw. versucht auf ein Minimum reduziert. Das klassische
...
Template zu sehen, in dem Platzhalter verwendet werden um \textit{XHTML}
...
an. Mit Haml lassen sich \textit{XHTML} Dokumente auf einer sehr viel
...
immer valides \textit{XHTML} erzeugt wird.

Statt der in \textit{XHTML} Dokumenten verwendeten und sehr viel Redundanz
...
zwei Leerzeichen verwendet. Die in \textit{XHTML} Dokumenten häufig in
...
simple arithmetische Operationen auszuführen und einige weitere sehr
...
Syntax von \textit{CSS} leicht in Vergessenheit geriet.
...
diesem \textit{DBMS} gesammelt, zum anderen wird die Funktionalität von
\textit{PostgreSQL} selbst und einiger der zur Verfügung stehenden
