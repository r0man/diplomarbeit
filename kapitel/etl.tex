...
Element wird eine Datei erstellt die alle Nachrichten des
entsprechenden Elements für die verschiedenen Zeitpunkte enthält.

Das \textit{Wave Watch III} Modell wird auf Serverseite in einer
einzigen \textit{GRIB} Datei veröffentlicht. Der Extraktionsprozess
für dieses Modell lädt das Inhaltsverzeichnis dieser Datei, extrahiert
die Start- und Endpositionen der gewünschten Elemente und sendet pro
Element eine \textit{HTTP} Anfrage mit dem entsprechenden
\textit{Range} Header.

\subsection{Messung der Downloadzeiten}
