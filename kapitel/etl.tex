...
Positionen, die sich auch über dem Meer befinden. Für alle anderen
Positionen stehen keine Daten zur Verfügung. In Abbildung
\ref{positions-bestimmung} ist ein Ausschnitt der Küstenregion um den
Ort Mundaka in Spanien zu sehen, und dem darüber liegenden Gitternetz
des \textit{Wave Watch III} Modells. Wegen der groben Gitterauflösung
sind nur an den Knotenpunkten des Gitters Vorhersagedaten vorhanden,
die in der Abbildung grün eingefärbt sind.
...
der näheren Umgebung eines Spots sehr ähnlich. Deshalb werden in der
hier entwickelten Applikation die Vorhersagedaten aus der Umgebung
eines Spots herangezogen, falls an der geographischen Position des
Spots keine Daten vorhanden sind. Eine Möglichkeit wäre dabei den
Benutzer beim Erstellen eines neuen Spots die Vorhersageposition mir
angeben zu lassen. Durch ein interaktives Formular in Verbindung mit
einer Karte könnte man den Benutzer beispielsweise dazu anleiten eine
Position auszuwählen, die etwas weiter von der Küste entfernt ist und
für die Vorhersagedaten existieren.
