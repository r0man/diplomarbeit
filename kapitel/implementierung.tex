...
aus den zuvor anayliserten Architekturen aufgreift und Richtlinien für
das Design moderner Web- Architekturen und Anwendungen
vorgibt. Fielding, der auch an der Spezifikation des \textit{Hypertext
  Transfer Protocol (HTTP)} \nomenclature{HTTP}{Hypertext Transfer
  Protocol} beteiligt war, führt den großen Erfolg des \textit{World
  Wide Web (WWW)} \nomenclature{WWW}{World Wide Web} auf dessen
Architektur und der verwendeten Technologien zurück, die sich in
einigen der vorgestellten Regeln widerspiegeln.
...
auf einem Web Server, Zeilen einer Datenbanktabelle oder auch das
Ergebnis eines Algorithmus auf einer bestimmten Eingabe können als
Ressource modelliert werden. Einige konkrete Beispiele sind:

\begin{itemize}
\item Die Version 3.0.12 eines Softwarepakets.
\item Die letzte stabile Version eines Softwarepakets.
\item Die Beschreibung der Surfbedingungen in Mundaka, Spanien.
\item Die Wettervorhersage für Mundaka am 26. Juli 2009 um 15:00h.
\end{itemize}
