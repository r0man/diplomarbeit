...
\textit{Ruby on Rails} ist ein in der Programmiersprache Ruby
geschriebenes Framework zur Entwicklung von Web Applikationen, das in
letzter Zeit viel Aufmerksamkeit auf sich gezogen hat. Durch
Prinzipien wie \textit{Don't Repeat Yourself (DRY)} und
\textit{Convention over Configuration} hat es die Art und Weise wie
Web Anwendungen entwickelt werden revolutioniert.
