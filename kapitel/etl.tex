...
bewerkstelligt, der die Ausgabe von \textit{degrib} in ein
\textit{CSV} \footnote{Statt dem in \textit{CSV} Dateien typischen
  Komma Zeichen '','' dient das, in der Auflistung nicht sichtbare,
  Tabulator Zeichen ''\textbackslash t'' als Separator.} Format
konvertiert, das in Auflistung \ref{degrib-csv} zu sehen ist.
